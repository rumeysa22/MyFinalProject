    ...
    public class InMemoryProductDal : IProductDal
    {
        ...
        public InMemoryProductDal()
        {
            _products = new List<Product>
            {
                ...
                new Product{ProductId =2, CategoryId = 1, ProductName = "Kamere", UnitPrice = 500, UnıtInStock = 3},
        ...
        {
            //gönderdiğim ürün idsine sahip olan listedeki ürürnü bul
        ...
        public List<Product> GetAllByCaategory(int categoryId)
        {
